...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.splitter.setGeometry(QtCore.QRect(20, 40, 174, 16))
        ...
        self.label_4.setGeometry(QtCore.QRect(120, 240, 271, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Kurs Dönüşümü"))
        ...
        self.dolar_label.setText(_translate("MainWindow", ""))
        self.comboBox.setItemText(1, _translate("MainWindow", "Dolar"))
        self.comboBox.setItemText(2, _translate("MainWindow", "Euro"))
        self.comboBox.setItemText(3, _translate("MainWindow", "Sterlin"))
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p>Bu Uygulama Üzerindeki Veriler Google Finans Onaylıdır.</p></body></html>"))
